...
public static class ContainsExtensions : Object
{
    ...
    public static Boolean ContainsAny(this String value, params Char[] values)
    {
        ArgumentException.ThrowIfNullOrEmpty(value);
        // ----------------------------------------------------------------------------------------------------
        SharperHacks.CoreLibs.Constraints.Verify.IsNotNull(value, nameof(value));
        // ----------------------------------------------------------------------------------------------------
    ...
    public static Boolean ContainsAny(this String value, params String[] values)
    {
        ArgumentException.ThrowIfNullOrEmpty(value);
        // ----------------------------------------------------------------------------------------------------
        SharperHacks.CoreLibs.Constraints.Verify.IsNotNull(value, nameof(value));
